...
<div class="container">
      ...
      <a href="{{route('create_country')}}">Create New Country</a>
      ...
      <table class="table table-hover">
          ...
          <tbody>
              @foreach ($countries as $country)
                  ...
                  <tr>
                      <td>{{$country->id}}</td>
                      <td><a href="{{URL::to('/admin/country')}}/{{$country->id}}">{{$country->name}}</a></td>
                      ...
                      <td>
                        ...
                        <a href="{{URL::to('/admin/country/edit')}}/{{$country->id}}" class="btn btn-outline-primary">Edit</a>
                        <form action="{{URL::to('/admin/country/delete')}}/{{$country->id}}" method="post">
